    ...
    return (
        <section id="inicio" className="relative h-screen w-full">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row h-full w-full">
                ...
                <div className="w-full lg:w-1/3 h-1/2 lg:h-full flex items-center justify-center lg:items-start lg:justify-center lg:pt-24">
                    <div className="bg-[#87888a]/20  rounded-lg border-2 border-[#f3efec] p-6 md:p-8 mx-4 lg:mx-6 w-full max-w-sm lg:ml-8">
